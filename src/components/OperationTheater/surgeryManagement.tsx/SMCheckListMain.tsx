...
const SMCheckListMain: React.FC = () => {
  return (
    <>
      <div className="">
        <div
        ...
        >
          <div className="emr-nav-doc-cl ps-3">
            <NavLink
              to="/operation-theater/surgery-management/surgery-management-setup/check-list/pre-anesthetic-fitness"
              className={({ isActive }) =>
            ...
            <NavLink
              to="/operation-theater/surgery-management/surgery-management-setup/check-list/admission-form"
              className={({ isActive }) =>
            ...
            <NavLink
              to="/operation-theater/surgery-management/surgery-management-setup/check-list/pre-operative-check-list"
              className={({ isActive }) =>
                `emr-link ms-3 ${isActive ? "active" : ""}`
              }
            >
            ...
            <NavLink
              to="/operation-theater/surgery-management/surgery-management-setup/check-list/anesthetic-assessment"
              className={({ isActive }) =>
                `emr-link ms-3 ${isActive ? "active" : ""}`
              }
            >
            ...
            <NavLink
              to="/operation-theater/surgery-management/surgery-management-setup/check-list/surgery-notes"
              className={({ isActive }) =>
                `emr-link ms-3 ${isActive ? "active" : ""}`
              }
            >
...
export default SMCheckListMain;
