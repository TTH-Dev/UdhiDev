...
const PIAddLens = () => {
  ...
  return (
    <div className="cont">
      ...
      <div>
        <p className="emr-search-text mb-0 p-3 pt-4">Add lens</p>
      </div>
      <Row className="p-3" gutter={32}>
        <Col span={12} className="my-2">
          <div>
            <label className="emr-label mb-2">Brand</label>
            <br />
        ...
        <Col span={12} className="my-2">
          <div>
            <label className="emr-label mb-2">Power</label>
            <br />
            <Input style={{ height: "35px" }} />
          </div>
        </Col>
        <Col span={12} className="my-2">
          <div>
            <label className="emr-label mb-2">Model </label>
            <br />
            <Input style={{ height: "35px" }} />
          </div>
        </Col>
