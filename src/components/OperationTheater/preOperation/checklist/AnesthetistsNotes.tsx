    ...
    <>
      <div className="emr-complaints-box mx-3">
        <p className="emr-label ps-3 pt-3">
          {" "}
          Anesthetist Notes (Post Operative)
        </p>
        ...
        <div className="ps-3 my-3">
          <label className="emr-label mb-2">Surgeon Signature Document</label>
          <br />
          <Upload>
        ...
        <Row gutter={32}>
          <Col span={12}>
            ...
            <div className="d-flex justify-content-between ps-3 my-3">
              <label style={labelStyle}>
                0= Saturation &lt; 90% even with supermental Oxygen
              </label>
              <Input style={inputStyle} />
            </div>
            ...
            <div className="px-3">
              <label className="emr-label mb-2">Date</label>
              <br />
          ...
          <Col span={12}>
            ...
            >
              <p className="emr-label">
                The total score is 10 . Patient scoring ≥8 ( and / ore are
                returned to similar pre op status ) are considered fit for
                transfer from recovery room to wards.
              </p>
            </div>
            <div style={{ marginTop: "85px" }}>
              <label className="emr-label mb-2 mt-5 px-3">
                Signature Document
              </label>
              <br />
