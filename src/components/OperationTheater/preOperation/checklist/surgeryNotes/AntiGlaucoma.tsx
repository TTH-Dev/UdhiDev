        ...
        <Form form={form} layout="vertical" onFinish={onFinish}>
          <Row gutter={32}>
            ...
            <Col span={12}>
              <Form.Item
                name="procedure"
                label="Procedure (Antiglaucoma Surgery)"
                className="emr-label"
              >
                <Input style={{ height: "40px" }} />
              </Form.Item>
          ...
          <Row gutter={32}>
            ...
            <Col span={12}>
              ...
              <p>
                <strong>Note</strong> Procedure done by local anaesthesia : 2% Licnocaine 3Ml + 0.5%
                Sensorcaine3Ml with Hynidase 25 units/Ml
              </p>
            </Col>
