...
const PreAuthorizationEmploymentReport = () => {
      ...
      <div>
        ...
        <div>
          ...
          <TextArea autoSize />
            ...
            <span className="emr-label " >Normal Report</span>
            ...
            <Col span={12} className="my-2">
              <div>
                <label className="mb-2 emr-label"> Color Vision ( Both Eye)</label>
                                <TextArea autoSize />
            ...
            <Col span={12} className="my-2">
              <div>
                <label className="mb-2 emr-label"> EOM (Both eye)</label>
                                <TextArea autoSize />
            ...
            <Col span={12} className="my-2">
              <div>
                <label className="mb-2 emr-label">Confrontation fields (Both Eye)</label>
                                <TextArea autoSize />
            ...
            <Col span={12} className="my-2">
              <div>
                <label className="mb-2 emr-label">OP Consultation (Both Eye)</label>
                                <TextArea autoSize />
            ...
            <Col span={12} className="my-2">
              <div>
                <label className="mb-2 emr-label"> SUGGESTED (Both Eye)</label>
                                <TextArea autoSize />
...
export default PreAuthorizationEmploymentReport;
